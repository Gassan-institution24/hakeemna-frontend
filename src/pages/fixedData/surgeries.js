...
function SubSpecialities(props) {
  ...
  return (
    <div>SubSpecialities
        {isAdding && <AddModel textDetails={[{name:'name',nameDB:'name'},{name:'description',nameDB:'description'}]} multiSelectDetails={[{name:'diseases',path:'diseases'}]} path={'surgeries'} setIsAdding ={setIsAdding} fetchData={fetchData}/>}
        {editting && <EditModel textDetails={[{name:'name',nameDB:'name'},{name:'description',nameDB:'description'}]} multiSelectDetails={[{name:'diseases',path:'diseases'}]} path={'surgeries'} editting={editting} fetchData={fetchData}/>}
