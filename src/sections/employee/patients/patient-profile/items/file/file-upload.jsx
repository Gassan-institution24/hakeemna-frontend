...
export default function PatientFileUpload({ patient }) {
    ...
    const validationSchema = yup.object().shape({
        ...
        patient_record_description: yup.string(),
    }).test(
        'at-least-one-field',
        'Either file or description must be provided',
        (values) => values.patient_record_file || values.patient_record_description?.trim()
    );

    const methods = useForm({
        defaultValues: {
            patient_record_file: null,
            patient_record_description: '',
        },
        mode: 'all',
