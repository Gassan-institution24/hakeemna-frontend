...
export default function MedicalReportUpload({ patient, refetch }) {
  ...
  const validationSchema = yup
    ...
    .shape({
      ...
      medical_report_description: yup.string().required(t('required field')),
    });

  const methods = useForm({
    defaultValues: { medical_report_file: null, medical_report_description: '' },
    mode: 'all',
...
MedicalReportUpload.propTypes = { patient: PropTypes.object, refetch: PropTypes.func };
