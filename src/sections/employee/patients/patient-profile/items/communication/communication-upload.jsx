...
function CommunicationUpload({ patient, refetch }) {
  ...
  const methods = useForm({
    defaultValues: useMemo(() => ({ date: null, description: '' }), []),
    mode: 'all',
...
CommunicationUpload.propTypes = { patient: PropTypes.object, refetch: PropTypes.func };
