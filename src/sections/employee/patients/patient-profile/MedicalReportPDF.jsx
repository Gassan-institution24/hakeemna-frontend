...
export default function MedicalReportPDF({ prescription }) {
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={[styles.rightLabel, { width: '50%' }]}>
                                ...
                                <Text style={styles.valueText}>
                                    {prescription?.created_at ? fDate(prescription?.created_at) : ''}
                                </Text>
                            </Text>
                ...
                <View style={{ marginTop: 25 }}>
                    {prescription?.medicines?.map((med, idx) => (
                        <View key={idx} style={styles.medicineBlock}>
                            ...
                            <Text style={styles.medicineField}>Frequency: {med.Frequency_per_day || ''}</Text>

                            <Text style={styles.medicineField}>
