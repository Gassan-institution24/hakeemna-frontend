...
export default function InvoiceListView() {
  ...
  const { economecMovementsData } = useGetUSEconomicMovements(user?.employee?.employee_engagements?.[user.employee.selected_engagement]?.unit_service?._id)
  ...
  const handleDeleteRow = useCallback(
    ...
    [dataInPage.length, enqueueSnackbar, table, economecMovementsData]
  );
  ...
  }, [dataFiltered.length, dataInPage.length, enqueueSnackbar, table, economecMovementsData]);
