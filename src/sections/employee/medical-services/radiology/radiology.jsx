...
export default function Radiology() {
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.employee.medicalServices.radiology.view(id)); /// edit
    },
    [router]
  );
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.employee.medicalServices.radiology.edit(id)); /// edit
    },
    [router]
  );
      ...
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.employee.medicalServices.radiology.new} /// edit
            variant="contained"
