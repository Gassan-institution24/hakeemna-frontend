...
export default function DiagnosisTableRow({ row, onEditRow, onViewRow }) {
  const {
    code,
    favorite_name,
    favorite_name_ar,
  ...
  return (
    <>
      <TableRow hover>
        <TableCell align="center" sx={{ cursor: 'pointer', color: '#3F54EB' }} onClick={onViewRow}>
          {code}
        </TableCell>
        <TableCell align="center" sx={{ cursor: 'pointer', color: '#3F54EB' }} onClick={onViewRow}>
          {favorite_name}
      ...
      <CustomPopover open={DDL.open} onClose={DDL.onClose} arrow="right-top" sx={{ padding: 2, fontSize: '14px' }}>
