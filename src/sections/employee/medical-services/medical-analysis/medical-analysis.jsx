...
export default function MedicalAnalysis() {
  ...
  const { favoriteMedicalAnalysis, loading } = useGetFavoriteMedicalAnalysis();
  ...
  const dataFiltered = applyFilter({
    inputData: favoriteMedicalAnalysis,
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.employee.medicalServices.medicalAnalysis.view(id)); /// edit
    },
    [router]
  );
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.employee.medicalServices.medicalAnalysis.edit(id)); /// edit
    },
    [router]
  );
      ...
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.employee.medicalServices.medicalAnalysis.new} /// edit
            variant="contained"
