...
export default function AdjustableTableView() {
  ...
  const { adjustabledocument, loading } = useGetEmployeeAdjustabledocument(user?.employee?._id);
  ...
  const handleDownload = () => {
    ...
    saveAs(data, 'adjustable.xlsx'); /// edit
  };
  ...
  return (
    <Container maxWidth="xl">
      <CustomBreadcrumbs
        heading={t('adjustable documents')} /// edit
        links={[
          {
            name: t('dashboard'),
        ...
        action={
          <Button
            ...
            href={paths.employee.documents.adjustable.new}
            variant="contained"
