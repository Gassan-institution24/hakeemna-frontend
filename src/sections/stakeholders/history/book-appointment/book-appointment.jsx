...
import AppointmentFiltersResult from './appointment-filters-result';
...
export default function AppointmentListView({stakeholderData}) {
    ...
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        ...
        links={[
          ...
          {
            name: 'History',
            href: paths.superadmin.stakeholders.history.root,
          },
          { name: 'Appointments' },
        ]}
        sx={{
      ...
      <AppointmentList stakeholderData={stakeholderData} refetch={refetch} appointments={dataFiltered} />
    </Container>
  );
}
