...
export default function TableNewEditForm({ currentTable }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      if (currentTable) {
        await axiosInstance.patch(endpoints.patients.onefamilyType(currentTable._id), data);
      } else {
        await axiosInstance.post(endpoints.patients.familyType, data);
      }
      reset();
      ...
      //   });
      // }
      router.push(paths.superadmin.tables.family_relation.root);
    } catch (error) {
      console.error(error);
    }
  });
