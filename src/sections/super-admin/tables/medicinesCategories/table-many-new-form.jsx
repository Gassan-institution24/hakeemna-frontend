...
// ----------------------------------------------------------------------
const TABLE_HEAD = [
  { label: 'speciality *', width: 'calc(100%/5)' },
...
export default function NewEditManyForm() {
  ...
  const handleCreate = async () => {
    const isFormValid = data.every((one) => one.name_english && one.name_arabic && one.speciality);
    if (!isFormValid) {
