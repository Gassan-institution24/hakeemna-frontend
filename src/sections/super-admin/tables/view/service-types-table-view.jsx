...
import { useGetServiceTypes } from 'src/api/tables'; /// edit
...
const TABLE_HEAD = [
  ...
  { id: 'Measurement_type', label: 'Measurement type' },
...
export default function ServiceTypesTableView() {
  ...
  const handleDownload = () => {
    ...
    saveAs(data, 'ServiceTypesTable.xlsx'); /// edit
  };
  ...
  const handleActivate = useCallback(
    async (id) => {
      await axiosHandler({
        method: 'PATCH',
        path: `${endpoints.tables.servicetype(id)}/updatestatus`, /// edit
        data: { status: 'active' },
      });
      refetch();
  ...
  const handleActivateRows = useCallback(async () => {
    await axiosHandler({
      method: 'PATCH',
      path: `${endpoints.tables.servicetypes}/updatestatus`, /// edit
  ...
  }, [dataFiltered.length, dataInPage.length, table, serviceTypesData, refetch]);
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.superadmin.tables.servicetypes.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.superadmin.tables.servicetypes.new}
              variant="contained"
