...
import { useGetTaxes } from 'src/api';
...
import TableDetailRow from '../taxes/table-details-row'; /// edit
...
export default function TaxesTableView() {
  ...
  const { taxesData, loading, refetch } = useGetTaxes();
  ...
  const handleDownload = () => {
    ...
    saveAs(data, 'TaxesTable.xlsx'); /// edit
  };
  ...
  const handleActivate = useCallback(
    async (id) => {
      await axiosInstance.patch(
        `${endpoints.tables.activity(id)}/updatestatus`, /// edit
        { status: 'active' }
      );
      refetch();
  ...
  const handleActivateRows = useCallback(async () => {
    axiosInstance.patch(
      `${endpoints.tables.activities}/updatestatus`, /// edit
