...
export default function ActivitesTableView() {
  ...
  const { activitiesData, loading, refetch } = useGetActivities();
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.superadmin.tables.activities.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.superadmin.tables.activities.new}
              variant="contained"
