...
import { useGetEmployeeTypes } from 'src/api';
...
export default function EmployeeTypesTableView() {
  ...
  const handleDownload = () => {
    ...
    saveAs(data, 'EmployeeTypesData.xlsx'); /// edit
  };
  ...
  const handleActivate = useCallback(
    async (id) => {
      await axiosInstance.patch(
        `${endpoints.tables.employeetype(id)}/updatestatus`, /// edit
        { status: 'active' }
      );
      refetch();
  ...
  const handleActivateRows = useCallback(async () => {
    axiosInstance.patch(
      `${endpoints.tables.employeetypes}/updatestatus`, /// edit
  ...
  }, [dataFiltered.length, dataInPage.length, table, employeeTypesData, refetch]);
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.superadmin.tables.employeetypes.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.superadmin.tables.employeetypes.new}
              variant="contained"
