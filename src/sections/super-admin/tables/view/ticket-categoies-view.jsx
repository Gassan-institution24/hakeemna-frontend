...
export default function TicketCategoriesTableView() {
  ...
  const { ticketCategoriesData, loading } = useGetTicketCategories();
  ...
  const dataFiltered = applyFilter({
    inputData: ticketCategoriesData,
  ...
  const handleDownload = () => {
    ...
    saveAs(data, 'TicketCategoriesTable.xlsx'); /// edit
  };
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.superadmin.tables.ticketCategories.edit(id));
    },
    [router]
  );
  ...
  return (
    <>
      <Container maxWidth="xl">
        <CustomBreadcrumbs
          heading="Ticket categories" /// edit
          links={[
            {
              name: 'dashboard',
          ...
          action={
            <Button
              ...
              href={paths.superadmin.tables.ticketCategories.new} /// edit
              variant="contained"
            ...
            {STATUS_OPTIONS.map((tab, idx)  => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {tab.value === 'all' && ticketCategoriesData.length}
                    {tab.value === 'active' &&
                      ticketCategoriesData.filter((order) => order.status === 'active').length}
                    {tab.value === 'inactive' &&
                      ticketCategoriesData.filter((order) => order.status === 'inactive').length}
                  </Label>
                }
              />
            ))}
