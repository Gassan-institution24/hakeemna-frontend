...
import { useGetWorkShifts } from 'src/api';
...
export default function WorkShiftsTableView() {
  ...
  const { workShiftsData, loading, refetch } = useGetWorkShifts();
  ...
  const handleActivate = useCallback(
    async (id) => {
      await axiosInstance.patch(
        `${endpoints.tables.workshift(id)}/updatestatus`, /// edit
        { status: 'active' }
      );
      refetch();
  ...
  const handleActivateRows = useCallback(async () => {
    axiosInstance.patch(
      `${endpoints.tables.workshifts}/updatestatus`, /// edit
