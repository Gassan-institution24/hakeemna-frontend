...
const TABLE_HEAD = [
  ...
  { id: 'city', label: 'city' },
  { id: 'unit_service_type', label: 'unit service type' },
  { id: 'sector', label: 'sector' },
  { id: 'type_of_specialty_1', label: 'specialty' },
  ...
  return (
    <>
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.superadmin.tables.hospitallist.new}
              variant="contained"
            ...
            {STATUS_OPTIONS.map((tab, idx) => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {tab.value === 'all' && hospitalsData.length}
                    {tab.value === 'active' &&
                      hospitalsData.filter((order) => order.status === 'active').length}
                    {tab.value === 'inactive' &&
                      hospitalsData.filter((order) => order.status === 'inactive').length}
                  </Label>
                }
              />
            ))}
                  ...
                  <MobileRow
                    ...
                    fields={[
                      ...
                      },
                      {
                        ...
                        value: row?.unit_service_type,
                      },
                      { label: 'Sector', value: row.sector },
                      { label: 'Specialty', value: row.type_of_specialty_1 },
                      {
                        label: 'Status',
                        value: (
                          <Label
      ...
      >
        {ddlRow && (
          <>
        <Box sx={{ fontWeight: 600 }}>Hospital DDL Info</Box>
