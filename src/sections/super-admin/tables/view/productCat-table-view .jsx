...
import TableDetailRow from '../product_category/table-details-row'; /// edit
...
export default function ProductCatTableView() {
  /// edit
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.superadmin.tables.productCat.edit(id));
    },
    [router]
  );
      ...
      <CustomBreadcrumbs
        ...
        action={
          <Button
            ...
            href={paths.superadmin.tables.productCat.new} /// edit
            variant="contained"
            ...
            {STATUS_OPTIONS.map((tab, idx) => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {tab.value === 'all' && productCat.length}
                    {tab.value === 'active' &&
                      productCat.filter((order) => order.status === 'active').length}
                    {tab.value === 'inactive' &&
                      productCat.filter((order) => order.status === 'inactive').length}
                  </Label>
                }
              />
            ))}
