...
// ----------------------------------------------------------------------
const TABLE_HEAD = [
  { label: 'name', width: 'calc(100%/5)' },
  { label: 'phone', width: 'calc(100%/5)' },
  { label: 'city', width: 'calc(100%/5)' },
  { label: 'notes', width: 'calc(100%/5)' },
  { label: 'communication_date', width: 'calc(100%/5)' },
];
