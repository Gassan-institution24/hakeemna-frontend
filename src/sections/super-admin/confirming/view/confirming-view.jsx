          ...
          <Card sx={{ p: 3, minWidth: '60vw' }}>
            <Stack direction={{ md: 'row' }} justifyContent='space-between' alignItems='center'>
              ...
              <Stack minWidth='40%' gap={1}>
                ...
                <Typography variant="subtitle2"> nationality : {one?.nationality?.name_english}</Typography>
                <Button variant="contained" color="primary" onClick={() => handleActivate(one._id)}>Activate</Button>
              </Stack>
            </Stack>
          </Card>
        ))}
