...
// export default function AppointHistoryView({ stakeholderData }) {
...
//   const { appointmentsData, refetch } = useGetStakeholderAppointments(stakeholderData._id);
...
//     router.push(paths.superadmin.stakeholders.history.addAppointment(stakeholderData._id));
