  ...
  const renderFooter = (
    <Grid container>
      ...
      <Grid xs={12} md={3} sx={{ py: 3, textAlign: 'right' }}>
        ...
        <Typography variant="body2">info@hakeemna.online</Typography>
      </Grid>
    </Grid>
  );
    ...
    <TableContainer sx={{ overflow: 'unset', mt: 5 }}>
      <Scrollbar>
        <Table sx={{ minWidth: 960 }}>
          ...
          <TableBody>
            {economicMovementData.Provided_services?.map((row, idx) => (
              <TableRow key={idx}>
      ...
      <Card sx={{ pt: 5, px: 5 }}>
        ...
        >
          ...
          <Stack sx={{ typography: 'body2' }}>
            ...
            {economicMovementData?.stakeholder?.first_name}{' '}
            {economicMovementData?.stakeholder?.last_name}
            <br />
            {economicMovementData?.stakeholder?.country} {economicMovementData?.stakeholder?.city}
            <br />
            Phone: {economicMovementData?.stakeholder?.mobile_num1}
            <br />
            Email: {economicMovementData?.stakeholder?.email}
            <br />
          </Stack>
