...
import { useGetPatientEconomicMovements } from 'src/api';
...
export default function EconomicMovementsView({ patientData }) {
  ...
  const { economecMovementsData, loading } = useGetPatientEconomicMovements(
    patientData._id
  );
  ...
  const handleEditRow = useCallback(
    (inid) => {
      router.push(paths.superadmin.patients.history.invoices.edit(patientData._id, inid));
    },
  ...
  const handleViewRow = useCallback(
    (inid) => {
      router.push(paths.superadmin.patients.history.invoices.info(patientData._id, inid));
    },
    [router, patientData._id]
  );
