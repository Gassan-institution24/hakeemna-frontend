...
export default function PatientInfoContent({ patientData }) {
  ...
  const renderContent = (
    <Stack component={Card} spacing={3} sx={{ p: 3 }}>
      ...
      {drug_allergies.length>0 &&<Stack spacing={2}>
      ...
      {diseases.length>0 &&<Stack spacing={2}>
      ...
      {surgeries.length>0 &&<Stack spacing={2}>
      ...
      {medicines.length>0 &&<Stack spacing={2}>
      ...
      {insurance.length>0 &&<Stack spacing={2}>
