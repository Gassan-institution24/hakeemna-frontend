...
import { useGetPatientFeedbacks } from 'src/api'; /// edit
...
export default function PatientFeedbackView({ patientData }) {
  /// edit
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: t(`${patientName} feedback`) }, /// edit
          ]}
          sx={{
            mb: { xs: 3, md: 5 },
          }}
