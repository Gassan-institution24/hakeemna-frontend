...
import CommunicationSort from '../communications-sort';
import CommunicationSearch from '../communications-search';
import CommunicationFilters from '../communications-filters';
import CommunicationFiltersResult from '../communication-filters-result';
...
export default function CommunicationListView() {
  ...
  const renderFilters = (
    ...
    >
      ...
      <Stack direction="row" spacing={1} flexShrink={0}>
        ...
        <CommunicationSort sort={sortBy} onSort={handleSortBy} sortOptions={JOB_SORT_OPTIONS} />
      </Stack>
    </Stack>
  );

  const renderResults = (
    <CommunicationFiltersResult
      filters={filters}
      onResetFilters={handleResetFilters}
      //
      canReset={canReset}
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <CommunicationList jobs={dataFiltered} />
    </Container>
  );
}
