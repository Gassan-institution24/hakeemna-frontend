  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>
          <ListItemText
            primary={free_subscription?.name_english}
            secondary={free_subscription?.period_in_months &&`${free_subscription?.period_in_months} months`}
        ...
        <TableCell>
          <ListItemText
            primary={subscription?.name_english}
            secondary={subscription?.period_in_months &&`${subscription?.period_in_months} months`}
            primaryTypographyProps={{ typography: 'body2', noWrap: true }}
            secondaryTypographyProps={{
              mt: 0.5,
              component: 'span',
