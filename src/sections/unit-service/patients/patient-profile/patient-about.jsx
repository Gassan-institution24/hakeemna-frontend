          ...
          <Stack>
            ...
            <ul>
              {patientData?.drug_allergies?.map((drug, index) => (
                <li key={index}>{curLangAr ? drug?.name_arabic : drug?.name_english}</li>
              ))}
            </ul>
          </Stack>
          <Stack>
            ...
            <ul>
              {patientData?.diseases?.map((disease, index) => (
                <li key={index}>{curLangAr ? disease?.name_arabic : disease?.name_english}</li>
              ))}
            </ul>
          </Stack>
          <Stack>
            ...
            <ul>
              {patientData?.surgeries?.map((surgery, index) => (
                <li key={index}>{curLangAr ? surgery?.name_arabic : surgery?.name_english}</li>
              ))}
            </ul>
          </Stack>
          <Stack>
