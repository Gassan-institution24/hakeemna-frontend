...
import { Box, Card, Stack, Button, Divider, Container, TextField, IconButton, Typography, Autocomplete } from '@mui/material'
...
export default function PatientUpload({ patient }) {
    ...
    const defaultDrug = {
        ...
        patient: patient?._id,
        unit_service_patient: patient?.patient?._id,
        medicines: null,
        Frequency_per_day: '',
        Start_time: '',
        End_time: '',
            ...
            <FormProvider methods={methods} >
                ...
                >
                    ...
                    <Card sx={{ p: 2 }}>
                        ...
                        />
                        <Stack direction='row' justifyContent='flex-end'>
                            <Button variant='contained' onClick={() => handleSubmit('medical_report')}>{t('save')}</Button>
                        </Stack>
                    </Card>
