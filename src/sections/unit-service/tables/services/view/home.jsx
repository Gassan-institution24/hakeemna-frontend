                ...
                .map((row) => (
                  <MobileRow
                    ...
                    fields={[
                      ...
                      {
                        label: t('description'),
                        value: curLangAr ? row.description_arabic : row.description_english,
                      },
                      {
                        label: t('work shift'),
                        value: curLangAr
                      ...
                      {
                        label: t('measurment type'),
                        value: curLangAr
                          ? row.Measurement_type?.name_arabic
                          : row.Measurement_type?.name_english,
                      },
                      {
