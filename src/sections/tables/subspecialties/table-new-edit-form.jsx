...
import { useGetSpecialties } from 'src/api/tables';
...
export default function TableNewEditForm({ currentTable }) {
  ...
  console.log('subbbbbbbbb',currentTable)
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      specialty: currentTable?.specialty?._id || null,
    }),
    [currentTable]
  );
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      ...
      router.push(paths.superadmin.tables.subspecialities.root);
