...
import { useGetSpecialties } from 'src/api/tables'; /// edit
...
export default function SpecialtiesTableView() {
  ...
  const handleDownload = () => {
    ...
    saveAs(data, 'specialtiesTable.xlsx'); /// edit
  };
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.superadmin.tables.specialities.new} /// edit
              variant="contained"
            ...
            {STATUS_OPTIONS.map((tab) => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {tab.value === 'all' && specialtiesData.length}
                    {tab.value === 'active' &&
                      specialtiesData.filter((order) => order.status === 'active').length}
                    {tab.value === 'inactive' &&
                      specialtiesData.filter((order) => order.status === 'inactive').length}
                  </Label>
                }
              />
            ))}
