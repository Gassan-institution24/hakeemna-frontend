      ...
      <Stack spacing={{ xs: 2, md: 3 }} sx={{ p: 3 }} flex={1}>
        ...
        <Stack sx={{ width: 1 }}>
          {!data && !USData && <>
            ...
            {values.to === 'to_patient' && <Stack direction="row" justifyContent="flex-start">
              <RHFAutocomplete
                lang="ar"
                sx={{ minWidth: 200 }}
                name="patient"
            ...
            {values.to === 'to_unit_service' && <Stack direction="row" justifyContent="flex-start">
              <RHFAutocomplete
                lang="ar"
                sx={{ minWidth: 200 }}
                name="unit_service"
          ...
          {(data || USData) && <Stack direction="row" alignItems="center" sx={{ mb: 1 }}>
