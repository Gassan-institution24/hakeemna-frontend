    ...
    <Container>
      <Stack gap={1}>
        ...
        <Typography paragraph>
          Please read the “Privacy Policy” carefully and understand all the terms before signing for acceptance and before using the Hakeemna.com Website or associated applications or pages related to the Platform.
          {'\n'}
        </Typography>
        ...
        <Typography paragraph>
          Part of your medical data stored in Hakeemna.com platform may be archived in the electronic records of the third party (medical service providers such as a medical clinic or health center) and you may not have permissions to browse it.
        ...
        <Typography paragraph>
          With regard to the data and information stored by the third party (medical service providers, for example, a clinic) in Hakeemna.com platform, they may have different privacy policies and internal regulation than Hakeemna.com platform, and therefore the sharing of their information with the user (the second party) is subject to the laws of the country in which the medical service provider operates, taking into account its own privacy regulation.
          {'\n'}
        </Typography>
        <Typography paragraph textAlign='right'>
          جزء من بياناتك الطبية المخزنة في منصة حكيمنا قد تكون مؤرشفة في السجلات الالكترونية لدى الطرف الثالث (مزودي الخدمة الطبية مثل عيادة طبية أو مركز صحي) وهي من ملكية ذلك الطرف وليست من ملكيتك، في حال قمت بحذف حسابك من منصة حكيمنا فان تلك المعلومات سوف تبقى مخزنة في السجلات التاريخية الطبية لتلك المؤسسة الطبية.
          في حال رغبتك بحذف معلوماتك من تلك المؤسسة الطبية، عليك التوصل مع تلك المؤسسة وطلب منهم حذف معلوماتك. هذه العملية، التواصل بينكم، التأكد من حذف المعلومات ليست من مسؤولية منصة حكيمنا.
          {'\n'}
        </Typography>
        <Typography paragraph>
          Part of your medical data stored on Hakeemna.com platform may be archived in the electronic records of third party (for example: medical clinic) and is owned by that party (medical clinic) and not yours, if you delete your account from Hakeemna.com platform, that information will remain stored in the medical historical archive of that medical institution.

          If you want to delete your information from that medical institution records, you must contact that institution and ask them to delete your information. This process (communication between you and the medical institution and ensure that the information is deleted) is not the responsibility of Hakeemna.com platform.
          {'\n'}
        </Typography>
        <Typography paragraph textAlign='right'>
        ...
        <Typography paragraph>
          Misuse resulting from the second party (users of the platform) and the resulting damage, as well as do not being able to bear the damage resulting from the misuse of third party on the platform.
          {'\n'}
        </Typography>
        <Typography paragraph textAlign='right'>
        ...
        <Typography variant="h4" textAlign='right' >
          سابعاً: سياسة ملفات تعريف الارتباط.
        </Typography>
        <Typography variant="h4" mb={2}>
          Seventh: Cookies Policy.
        </Typography>
        <Typography paragraph textAlign='right'>
        ...
        <Typography variant="h4" textAlign='right' >
          ثامناً: الخسائر والتعويضات
        </Typography>
        <Typography variant="h4" mb={2}>
          Eighth: Losses and compensation
        </Typography>
        <Typography paragraph textAlign='right'>
