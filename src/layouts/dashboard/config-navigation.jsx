        ...
        items: [
          ...
          // ORDER
          {
            ...
            children: [
              ...
              { title: t('insurance_companies'), path: paths.superadmin.tables.insurancecomapnies.root },
              { title: t('unit_services'), path: paths.superadmin.tables.unitservices.root },
              ...
              { title: t('sub_specialities'), path: paths.superadmin.tables.subspecialities.root },
              { title: t('appointment_types'), path: paths.superadmin.tables.appointypes.root },
              { title: t('free_subscriptions'), path: paths.superadmin.tables.freesub.root },
              { title: t('added_value_taxes'), path: paths.superadmin.tables.taxes.root },
            ],
          },
