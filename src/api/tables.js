...
export function useGetCity(id) {
  const URL = endpoints.tables.city(id);
...
export function useGetSurgeries() {
  const URL = endpoints.tables.surgeries;
...
export function useGetSurgery(id) {
  const URL = endpoints.tables.surgery(id);
...
export function useGetSymptoms() {
  const URL = endpoints.tables.symptoms;
...
export function useGetSymptom(id) {
  const URL = endpoints.tables.symptom(id);
...
export function useGetCategories() {
  const URL = endpoints.tables.categories;
...
export function useGetCategory(id) {
  const URL = endpoints.tables.category(id);
...
export function useGetMedFamilies() {
  const URL = endpoints.tables.medfamilies;
...
export function useGetMedFamily(id) {
  const URL = endpoints.tables.medfamily(id);
...
export function useGetMedicines() {
  const URL = endpoints.tables.medicines;
...
export function useGetMedicine(id) {
  const URL = endpoints.tables.medicine(id);
...
export function useGetAnalyses() {
  const URL = endpoints.tables.analyses;
...
export function useGetAnalysis(id) {
  const URL = endpoints.tables.analysis(id);
...
export function useGetUnitservices() {
  const URL = endpoints.tables.unitservices;
...
export function useGetUnitservice(id) {
  const URL = endpoints.tables.unitservice(id);
