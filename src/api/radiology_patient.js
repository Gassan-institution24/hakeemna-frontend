...
export function useGeEntranceRadiologyPatient(id) {
  const URL = endpoints.radiologyPatient.entrance(id);
...
export function useGetOneRadiologyPatient(id) {
  const URL = endpoints.radiologyPatient.oneRadiology(id);
