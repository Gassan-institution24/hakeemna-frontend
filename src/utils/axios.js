...
export const endpoints = {
  ...
  tables: {
    ...
    usEmployees: (id) => `/api/employees/unitservice/${id}`,
    usEmployeesCount: (id) => `/api/employees/unitservice/${id}/count`,
    departmentEmployees: (id) => `/api/employees/department/${id}`,
    departmentEmployeesCount: (id) => `/api/employees/department/${id}/count`,
